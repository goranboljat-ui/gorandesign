...
const services = [
  { name: "Buzz Cut", price: "€15", desc: "All-over clipper cut — clean and fast" },
  { name: "Classic Haircut", price: "€20", desc: "Scissor or clipper cut, styled finish" },
  { name: "Skin Fade", price: "€22", desc: "Sharp skin fade, blended to perfection" },
  { name: "Beard Shape", price: "€13", desc: "Define your beard line, trimmed and neat" },
  { name: "Cut & Beard", price: "€30", desc: "Haircut and full beard treatment" },
  { name: "Kids (u.12)", price: "€13", desc: "Fun and fast, wash and cut" },
];

const gallery = [
  { url: "https://media.base44.com/images/public/69cad935d23d3a98efa0f99b/f3df276ac_generated_image.png", label: "Fresh Fades" },
  { url: "https://media.base44.com/images/public/69cad935d23d3a98efa0f99b/df6ae27ac_generated_image.png", label: "The Shop" },
  { url: "https://media.base44.com/images/public/69cad935d23d3a98efa0f99b/f9e0b0c02_generated_image.png", label: "Barbershop Vibes" },
  { url: "https://media.base44.com/images/public/69cad935d23d3a98efa0f99b/f3df276ac_generated_image.png", label: "Precision Work" },
];

const reviews = [
  { name: "Darragh K.", text: "Best value barbershop in Cork — the buzz cut is always clean and tidy and the lads are sound. Can't recommend enough." },
  { name: "Cormac O'S.", text: "Discovered Buzz Cutz six months ago and haven't gone anywhere else since. Consistent, friendly and the skin fades are 10/10." },
  { name: "Patrick N.", text: "Easy walk-in, no waiting, quality cut every time. Exactly what you want from a local barber." },
];

export default function BuzzCutz() {
  ...
  return (
    <div style={{ fontFamily: "'Georgia', serif", background: LIGHT, color: DARK, minHeight: "100vh" }}>
      ...
      <div style={{ background: DARK, color: "#aaa", fontSize: isMobile ? 11 : 12, padding: "8px 24px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 8 }}>
        <span>📍 Gurranabraher Road, Cork</span>
        <div style={{ display: "flex", gap: 20 }}>
          <span>📞 087 142 6948</span>
          <span>⏰ Mon–Sat 9:00–17:30</span>
        </div>
      </div>
      ...
      <nav style={{ background: LIGHT, borderBottom: "1px solid #eee", padding: "0 24px", position: "sticky", top: 0, zIndex: 100 }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", height: 64, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div>
            <div style={{ fontSize: isMobile ? 20 : 24, fontWeight: 900, letterSpacing: 3, textTransform: "uppercase" }}>Buzz Cutz</div>
            <div style={{ fontSize: 9, letterSpacing: "0.4em", color: TEXTGREY, textTransform: "uppercase" }}>— Barbershop · Gurranabraher —</div>
          </div>
          {isMobile ? (
      ...
      <section id="home" style={{ position: "relative", height: isMobile ? "70vh" : "90vh", overflow: "hidden" }}>
        <img src="https://media.base44.com/images/public/69cad935d23d3a98efa0f99b/f3df276ac_generated_image.png" alt="Buzz Cutz" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
        <div style={{ position: "absolute", inset: 0, background: "rgba(8,6,4,0.6)" }} />
        <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "flex-end", padding: isMobile ? "2rem 1.5rem 4rem" : "3rem 5rem 6rem" }}>
          <div>
            <p style={{ color: "rgba(255,255,255,0.65)", fontSize: isMobile ? 13 : 15, letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: 12 }}>Gurranabraher · Cork</p>
            <h1 style={{ fontSize: isMobile ? "clamp(40px,12vw,72px)" : "clamp(56px,8vw,96px)", margin: "0 0 16px", lineHeight: 1.0, color: LIGHT }}>
              <em style={{ fontWeight: 400 }}>Fresh cuts at</em><br />
              <strong style={{ fontWeight: 900, letterSpacing: -1 }}>Buzz Cutz</strong>
            </h1>
            <p style={{ color: "rgba(255,255,255,0.65)", fontSize: isMobile ? 14 : 17, maxWidth: 500, lineHeight: 1.7, marginBottom: 32 }}>
              Your neighbourhood barbershop in Gurranabraher. Walk-in friendly, quality cuts, honest prices. Monday to Saturday.
            </p>
        ...
        <a href="tel:0871426948" style={{ position: "absolute", bottom: isMobile ? 24 : 40, right: isMobile ? 16 : 40, background: ACCENT, color: LIGHT, width: 80, height: 80, borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", textAlign: "center", fontSize: 10, fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", textDecoration: "none", lineHeight: 1.3, boxShadow: "0 4px 20px rgba(0,0,0,0.3)" }}>
          BOOK<br />NOW
        </a>
      </section>
      ...
      <section style={{ background: GREY, padding: isMobile ? "60px 24px" : "90px 48px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto", textAlign: "center" }}>
          <Fade>
            <div style={{ fontSize: 10, color: ACCENT, letterSpacing: "0.5em", textTransform: "uppercase", marginBottom: 16 }}>Your Local Barber</div>
            <h2 style={{ fontSize: isMobile ? "clamp(28px,7vw,44px)" : "clamp(36px,5vw,56px)", fontWeight: 700, fontStyle: "italic", margin: "0 0 20px", lineHeight: 1.15 }}>No fuss. Just great cuts.</h2>
            <p style={{ color: TEXTGREY, fontSize: 16, lineHeight: 1.9, maxWidth: 640, margin: "0 auto" }}>
              Buzz Cutz keeps it simple — skilled barbers, fair prices, and a relaxed atmosphere where you always leave looking sharp.
            </p>
          </Fade>
        </div>
      </section>
      ...
      <footer style={{ background: "#111", padding: "2rem 20px", textAlign: "center" }}>
        <p style={{ fontSize: 12, color: "#666", letterSpacing: "0.1em" }}>Your local barbershop in Gurranabraher. Walk-ins always welcome.</p>
        <div style={{ display: "flex", justifyContent: "center", gap: 28, flexWrap: "wrap", marginTop: 12 }}>
          <a href="https://maps.google.com/?q=BuzzCutz+11b+Gurranabraher+Road+Cork" target="_blank" rel="noopener noreferrer" style={{ color: "#999", textDecoration: "none", fontSize: 13 }}>📍 Google Maps</a>
          <a href="https://www.facebook.com/people/BuzzCutz-Barber-Shop/61587525195744/" target="_blank" rel="noopener noreferrer" style={{ color: "#999", textDecoration: "none", fontSize: 13 }}>📘 Facebook</a>
          <a href="https://www.instagram.com/buzzcutzcork/" target="_blank" rel="noopener noreferrer" style={{ color: "#999", textDecoration: "none", fontSize: 13 }}>📸 Instagram</a>
        </div>
      </footer>
    </div>
  );
